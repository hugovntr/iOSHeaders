...
@class SBNowPlayingBarView, MPAudioVideoRoutingPopoverController, SBSwitcherVolumeSlider, MPAudioDeviceController, UIViewController, UIButton, MPAudioVideoRoutingActionSheet, SBApplication, SBAirPlayBarView;
