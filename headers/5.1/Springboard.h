...
@class SBAppContextHostManager, NSMutableArray, NSString, NSURL, NSTimer, UIWindow, NSDictionary, SBDimmingWindow, NSSet, SBUIController, NSDate, SBApplication, NSMutableSet, NSNumberFormatter;
