...
@class SBRootFolder, SBIcon, SBIconScrollView, SBSearchView, SBFolder, SBIconModel, SBFolderView, SBDockIconListView, SBIconListView, NSMutableSet, SBLeafIcon, SBFolderSlidingView, UITouch, SBWallpaperNotchView, UIView, SBIconIndexPath, TPLCDTextView, NSTimer, SBIconListPageControl, SBFolderScrollOffset, BBObserver, NSMutableArray, SBSearchController;
...
-(void)getListView:(id*)view folder:(id*)sfolder relativePath:(id*)path forIcon:(id)icon;
-(void)getListView:(id*)view folder:(id*)folder relativePath:(id*)path forIndexPath:(id)path4 createIfNecessary:(BOOL)necessary;
