...
@interface SBPowerDownController : SBAlert <SBPowerDownViewDelegate>
{
    ...
    _Bool _wasStatusBarHiddenAtActivation;
}

@property(nonatomic) _Bool wasStatusBarHiddenAtActivation; // @synthesize wasStatusBarHiddenAtActivation=_wasStatusBarHiddenAtActivation;
...
- (_Bool)powerDownViewShouldShowStatusBarWhenAnimatingOut:(id)arg1;
