...
@class NSIndexPath, NSString, SBIcon, SBIconModel, SBIconViewMap, SBStarkFakeIconOperationController, SBStarkFolderController, SBStarkIconLayoutOverrideStrategy, _UILegibilitySettings;
