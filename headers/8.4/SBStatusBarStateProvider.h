...
@interface SBStatusBarStateProvider : NSObject <SBStatusBarStateAggregatorPosting, UIStatusBarStateProvider>
{
    ...
    CDStruct_bf99eeea _aggregatorData;
    int _aggregatorActions;
    CDStruct_bf99eeea _lastPost;
    unsigned long long _coalescentBlockDepth;
    _Bool _itemNeedsPost[26];
...
- (void)statusBarStateAggregatorDidFinishPost:(id)arg1 withData:(const CDStruct_bf99eeea *)arg2 actions:(int)arg3;
- (void)statusBarStateAggregator:(id)arg1 didUpdateNonItemData:(const CDStruct_bf99eeea *)arg2;
- (void)statusBarStateAggregator:(id)arg1 didVisitItem:(int)arg2 withUpdates:(_Bool)arg3 toData:(const CDStruct_bf99eeea *)arg4;
...
- (void)getStatusBarData:(CDStruct_bf99eeea *)arg1;
