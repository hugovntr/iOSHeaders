...
@class NSMutableDictionary, NSString, SBDashBoardViewController, SBFAuthenticationAssertion, SBFUserAuthenticationController, SBLiftToWakeManager, SBLockScreenAutoUnlockAggregateRule, SBLockScreenDisabledAssertionManager, SBLockScreenMesaCoordinator, SBLockScreenUnlockRequest, SBLockScreenViewControllerBase, SBPasscodeEntryAlertViewController;
