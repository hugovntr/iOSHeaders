...
@class NSSet, NSString, SBNotificationCenterLayoutViewController, SBNotificationCenterScrollToTopView, SBNotificationCenterWithSearchViewController, SBNotificationSeparatorView, SBSearchBackdropView, SBUIChevronView, UIGestureRecognizer, UIPageControl, UIStatusBar, UIView, _UIBackdropView;
