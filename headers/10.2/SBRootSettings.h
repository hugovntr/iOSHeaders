...
@property(retain) NCMaterialSettings *notificationAndCCMaterialSettings; // @synthesize notificationAndCCMaterialSettings=_notificationAndCCMaterialSettings;
