...
+ (Class)viewClass;
+ (id)sharedInstance;
@property(nonatomic) _Bool widgetsBlurContent; // @synthesize widgetsBlurContent=_widgetsBlurContent;
...
- (void)_returnToRootViewControllerForSearchIfNeeded:(_Bool)arg1;
