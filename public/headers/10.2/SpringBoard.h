...
@class BBDataProviderConnection, NSDate, NSHashTable, NSMutableArray, NSMutableSet, NSNumberFormatter, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSSet, NSString, NSTimer, SBAccountStoreManager, SBAppStatusBarSettingsAssertion, SBApplication, SBBluetoothAccessoryBatteryMonitor, SBCardItemsController, SBCombinationHardwareButton, SBFUserAuthenticationController, SBHomeHardwareButton, SBLockHardwareButton, SBMainDisplayInterfaceOrientationAggregator, SBModalAlertPresentationCoordinator, SBModalAlertPresenter, SBNCNotificationDispatcher, SBPowerDownController, SBPressSequenceAWDLogger, SBRestartManager, SBSStatusBarStyleOverridesAssertion, SBScreenshotManager, SBSynchronizeCloudCriticalDataOperation, SBUIController, SBUserSessionController, SBWidgetController, UIWindow;
