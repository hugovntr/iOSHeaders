...
@class NSMutableArray, UIView, SBDismissOnlyAlertItem, SBShowcaseController, MPAudioDeviceController, SBZoomView, NSArray, SBSwitchAppGestureView, SBWallpaperView, UIWindow, SBAnimationStepper, NSMutableDictionary, SBAppToAppTransitionController, UIStatusBarCorners, SBUIRootView, SBApplication, UIStatusBar, SBWallpaper;
