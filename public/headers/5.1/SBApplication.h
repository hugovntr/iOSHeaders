...
@class PCPersistentTimer, NSMutableArray, SBAppContextHostManager, SBProcess, SBProcessAssertion, NSString, NSTimer, NSArray, NSDictionary, UIRemoteApplication, NSDate, UILocalNotification, SBCFBundle;
...
-(void)renewWatchdogAssertionWithToken:(unsigned)token timeout:(double*)stimeout;
