...
@class UIView, SBAwayInCallController, SBAwayChargingView, SBActivationView, NSTimer, UIButton, TPBottomSingleButtonBar, SBAwayLockBar, SBAwayBuddyBackgroundView, UIAlertView, NSDictionary, SBAwayDateView, SBAwayBulletinListController, SBAwaySwipeGestureRecognizer, SBAwayViewPluginController, SBAlertImageView;
