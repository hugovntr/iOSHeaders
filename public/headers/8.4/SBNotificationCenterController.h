...
@class FBUIApplicationResignActiveAssertion, NSMutableSet, NSSet, NSString, NSTimer, SBChevronView, SBLockScreenActionContext, SBNotificationCenterSettings, SBNotificationCenterViewController, SBWindow, UILongPressGestureRecognizer, UIView;
